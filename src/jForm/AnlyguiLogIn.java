 ...
 * @author marco
 */
public class AnlyguiLogIn extends javax.swing.JFrame {

    /**
     * Creates new form AnlyguiLogIn
     */
    public AnlyguiLogIn() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnlyguiLogIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnlyguiLogIn().setVisible(true);
            }
        });
    }
